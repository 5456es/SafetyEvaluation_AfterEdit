...
edit_times=(1 10 50 100)

for i in "${edit_times[@]}"
do
	python evaluate_llama.py \
		--model_path "/home/k/kduan/szn_workspace/SafetyEvaluation_AfterEdit/results/ROME/llama-2-7b/ZsRE_$i/edited_model"\
