...
do
	for j in "${Data_Piece[@]}";
	do
	python edit_mistral_then_eval.py 	--hparams_dir /home/k/kduan/szn_workspace/SafetyEvaluation_AfterEdit/hparams/MEMIT/mistral-7b-soc.yaml --safty_eval_data /home/k/kduan/szn_workspace/SafetyEvaluation_AfterEdit/data/Eval_data/merged_data_2024-10-18.json  --safty_eval_output /home/k/kduan/szn_workspace/SafetyEvaluation_AfterEdit/safety_evaluate/mistral/MEMIT/test_and_eval_$i/part_$j  --ds_size $i  --data_path ../../data/Edit_data/merged_data_part_$j.json  
	done
done
