...
echo "We have cd to $(pwd)"
	...
	python test_llama.py 	--model_path /home/k/kduan/szn_workspace/hf_cache_soc/llama-2-7b-chat-hf/  --safty_eval_data /home/k/kduan/szn_workspace/SafetyEvaluation_AfterEdit/data/Eval_data/merged_data_2024-10-18.json  --safty_eval_output /home/k/kduan/szn_workspace/SafetyEvaluation_AfterEdit/safety_evaluate/llama/baseline/
